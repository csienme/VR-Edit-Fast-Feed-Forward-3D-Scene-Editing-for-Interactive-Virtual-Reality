...
# PAUL MOD
import eval.generative_inpaint_module_0 as generative_inpaint_module_0
...
def main():
    ...
    try:
        ...
        (
            ...
            depth_conf_maps,      # ⬅️ 接收信賴度
            dense_features_maps   # ⬅️ 接收高維特徵
        ) = infer_vggt_and_reconstruct(
        ...
        if args.enable_gen_3d_prop:
            if args.mask_path is None or not args.mask_path.exists():
                ...
                # 引用我們剛剛建立的新模組
                from eval.generative_inpaint_module_0 import generative_multi_ref_propagation
 ...
 # 參數設定
                ...
                while True:
                    ...
                    for tgt_idx in target_indices_to_test:
                        ...
                        red_area, boundary_mse = generative_multi_ref_propagation(
                            ...
                            depth_conf_maps=depth_conf_maps,         # ⬅️ 傳入信賴度
                            dense_features_maps=dense_features_maps  # ⬅️ 傳入高維特徵  
                        )
                ...
                for ref_idx in active_ref_indices:
                    ...
                    if ref_idx in global_ref_cache:
                        ...
                        # 定義儲存路徑
                        save_path = output_scene_dir / f"{args.exp_name}" / f"inpainted_{ref_idx}.png"
