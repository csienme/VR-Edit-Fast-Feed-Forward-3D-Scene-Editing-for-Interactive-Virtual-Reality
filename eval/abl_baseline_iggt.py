...
from vggt_nobias.models.vggt import VGGT
from vggt_nobias.utils.eval_utils import (
    load_poses,
    get_vgg_input_imgs,
...
from vggt_nobias.utils.geometry import unproject_depth_map_to_point_map   # ← 新增
from vggt_nobias.utils.helper import (                                      # ← 新增
...
def main():
    ...
    try:
        ...
        if args.mask_path is None or not args.mask_path.exists():
            ...
            from eval.abl_inpaint_module import generative_multi_ref_propagation
