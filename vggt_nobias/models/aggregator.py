...
from vggt_nobias.layers import PatchEmbed
from vggt_nobias.layers.block import Block
from vggt_nobias.layers.rope import RotaryPositionEmbedding2D, PositionGetter
from vggt_nobias.layers.vision_transformer import vit_small, vit_base, vit_large, vit_giant2
import time
...
class Aggregator(nn.Module):
    ...
    def forward(self, images: torch.Tensor, inpaint_mask=None) -> Tuple[List[torch.Tensor], int]:
            ...
            if self.vis_attn_map:
                import vggt_nobias.layers.attention as attn_module
